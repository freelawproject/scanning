...
- An unnumbered page's `logical_number` is its PDF page, a display value (#403): no placement and no card link reads it as a printed number. A `missing_page` card links by its placeholder's `anchor_pdf_page`
