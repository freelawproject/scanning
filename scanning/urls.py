...
urlpatterns = [
    ...
    path("scans/<int:pk>/refine-redactions/", refine_redactions_api, name="refine_redactions_api"),
    ...
    path("scans/<int:pk>/redetect-page/", redetect_page, name="redetect_page"),
    path("scans/<int:pk>/add-single-detection/", add_single_detection, name="add_single_detection"),
    path("scans/<int:pk>/scan-for-label/", scan_for_label, name="scan_for_label"),
