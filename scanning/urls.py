...
urlpatterns = [
    ...
    path("scans/<int:pk>/original-crop/", serve_original_crop, name="serve_original_crop"),
    path("scans/<int:pk>/start-validate/", start_validate, name="start_validate"),
    path("scans/<int:pk>/start-detect/", start_detect, name="start_detect"),
    path("scans/<int:pk>/cancel/", cancel_processing, name="cancel_processing"),
    ...
    path("scans/<int:pk>/detections/", serve_detections, name="serve_detections"),
    path("scans/<int:pk>/opinions-json/", serve_opinions, name="serve_opinions"),
    path("scans/<int:pk>/margin-rects/", serve_margin_rects, name="serve_margin_rects"),
    path("scans/<int:pk>/redaction-rects/", serve_redaction_rects, name="serve_redaction_rects"),
    path("scans/<int:pk>/save-redaction-rect/", save_redaction_rect, name="save_redaction_rect"),
    path("scans/<int:pk>/save-margin-rect/", save_margin_rect, name="save_margin_rect"),
    path("scans/<int:pk>/pair-opinions/", pair_opinions_api, name="pair_opinions_api"),
    path("scans/<int:pk>/compute-redactions/", compute_redactions_api, name="compute_redactions_api"),
    path("scans/<int:pk>/generate-files/", generate_files, name="generate_files"),
    path("scans/<int:pk>/approve/", approve_scan, name="approve_scan"),
    path("scans/<int:pk>/redacted-pdf/", serve_redacted_pdf, name="serve_redacted_pdf"),
    path("scans/<int:pk>/opinion/<str:filename>/", serve_opinion_pdf, name="serve_opinion_pdf"),
    path("scans/<int:pk>/unredacted/<str:filename>/", serve_unredacted_opinion_pdf, name="serve_unredacted_opinion_pdf"),
    path("scans/<int:pk>/masked/<str:filename>/", serve_masked_opinion_pdf, name="serve_masked_opinion_pdf"),
    path("scans/<int:pk>/opinion-edit/<int:opinion_pk>/apply-rect/", apply_rect_to_opinion, name="apply_rect_to_opinion"),
    path("scans/<int:pk>/ocr-results/", serve_ocr_results, name="serve_ocr_results"),
    ...
    path("queue/<str:reporter_slug>/<int:vol>/", queue_detail_view, name="queue_detail"),
    path("queue/<str:reporter_slug>/<int:vol>/upload/", queue_upload, name="queue_upload"),
    path("queue/<str:reporter_slug>/<int:vol>/claim/", claim_scan, name="claim_scan"),
    path("queue/<str:reporter_slug>/<int:vol>/status/", update_scan_status, name="update_scan_status"),
