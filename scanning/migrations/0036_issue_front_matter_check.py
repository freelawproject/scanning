# Generated by Django 6.0.3 on 2026-09-17 14:35
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("front_matter", "Unnumbered pages at the front"),
                    ...
                    ("mislabeled_document", "Mislabeled document type"),
                    ("auto_corrected", "Auto-corrected page number"),
                    ("blank_page", "Blank page detected"),
                    ("orientation", "Page orientation issue"),
                    ("stale_page_edit", "Page edit not applied"),
                    ("process_flag", "User-flagged issue"),
                    (
                        "unmatched_key_icon",
                        "Key icon not matched to an opinion",
                    ),
                    ("unmatched_caption", "Caption not matched to an opinion"),
                    ("uncovered_pages", "Pages not covered by an opinion"),
                    (
                        "uncovered_headnote",
                    ...
                    ("stale_detection_edit", "Detection decision not applied"),
                    ("stale_redaction_edit", "Redaction decision not applied"),
                    (
                        "stale_boundary_edit",
