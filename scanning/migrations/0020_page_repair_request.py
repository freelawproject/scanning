        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("insert", "Scan a missing page"),
                            ("replace", "Scan this page again"),
                        ],
                        db_index=True,
                        max_length=16,
                    ),
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="REPLACE only: the 1-based page of the original PDF to scan again.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="INSERT only: the 1-based original page the missing leaf follows. 0 puts it before page 1.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="The printed page number, a label for the scanner. It never locates the page.",
                        max_length=32,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="The scan's source fingerprint when the request was made. Blank matches anything.",
                        max_length=64,
                    ),
                ),
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        db_index=True,
                        help_text="When a person judged the request unnecessary. A stamped row is history, and it is never rewritten.",
                        null=True,
                    ),
                ),
                (
